...
# URL do vídeo específico
url = "https://g1.globo.com/pe/petrolina-regiao/ao-vivo/ao-vivo-assista-ao-gr2.ghtml"
...
with open("lista1.m3u", "w") as output_file:
    print(f"Processando link: {url}")

    try:
        title, m3u8_url, thumbnail_url = extract_globoplay_data(driver, url)
        ...
        if m3u8_url:
            ...
            print(f"Link .m3u8 não encontrado para {url}")
