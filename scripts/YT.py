                ...
                if link_href and link_href not in processed_links:  # Verifica se o link já foi processado
                    ...
                    with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                        ...
                        if 'id' in info_dict:  # Garantir que 'id' do vídeo seja encontrado
                            ...
                            thumbnail_url = info_dict.get('thumbnail', 'https://i.ytimg.com/vi/default_thumbnail.jpg')
...
# URL da página desejada (YouTube com resultados de busca)
url_youtube = "https://www.youtube.com/results?search_query=%22a+fazenda+ao+vivo%22&sp=EgJAAQ%253D%253D"
